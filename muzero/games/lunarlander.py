...
CONFIG = with_defaults({
    ...
    ### Game
    'name': 'lunarlander',
    'observation_shape': (1, 1, 8),  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
    ...
    'max_moves': 700,  # Maximum number of moves if game is not finished before,
    ...
    'fc_policy_layers': [64],  # Define the hidden layers in the policy network

    ### Training
    'training_steps': 200000,  # Total number of training steps (ie weights update according to a batch)
    ...
    ### Replay Buffer
    'replay_buffer_size': 2000,  # Number of self-play games to keep in the replay buffer
    ...
    'visit_softmax_temperature_fn': lambda trained_steps: 0.35,
})
